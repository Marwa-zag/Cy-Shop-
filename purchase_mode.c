...
void purchase_mode() {
    ...
    do {
        ...
        printf("7. Les 3 derniers achats d'un client\n");
        printf("8. Historique d'achats\n");
        printf("9. Quitter\n");
        printf("Choix : ");
        scanf("%d", &choix);
        vider_buffer();
        ...
        switch (choix) {
           case 1: {
            ...
            case 6: {
              ...
              printf("ID du client : ");
              scanf("%d", &client_id);
              getchar(); // Lire le caractère de nouvelle ligne restant
              printf("Nom du produit : ");
              fgets(product_name, sizeof(product_name), stdin);
              product_name[strcspn(product_name, "\n")] = '\0';  // Supprimer le caractère de nouvelle ligne
              delete_achat(client_id, product_name); // Appel à la fonction pour supprimer un achat
              break;
            }
            case 7: {
              int client_id;
